    ...
    public void runProgram(int progId, String resultPath, String resultPath2) throws Exception {
        ...
        switch (progId) {
            case 1: {
                ...
                /*
                 * The first three tests test whether or not three predefined datasets produce the
                 * correct theta value. The correctness of the theta value was validated through a
                 * scala and a Matlab implementation of the logist regression algorithm.
                 */
