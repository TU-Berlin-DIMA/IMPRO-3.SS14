...
/**
 * The Generic function to be passed to KMeans++ algorithm, which can be used to define the input format,
 * get the distance matrix and calculate the prototype of new cluster
 *
 * @param <T>
 *           genric type
 */
public interface GenericFunctions<T> extends Serializable  {
	...
	/**
	 * User defined Addition function for input data. Together with div function to calculate the average.
	 * @param in1 input1
	 * @param in2 input2
	 * @return sum
	 */
